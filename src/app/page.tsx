      ...
      <div className='min-h-[calc(100vh-85px)] max-w-[1000px] mx-auto px-2 flex flex-col justify-center items-center text-xl'>
        ...
        {/* name tag */}
          <div className='h-[150px] w-[300px] text-center bg-[#1c325f] rounded-3xl border-4 -rotate-6'>
            <div className='h-[35px] p-1 bg-[#1c325f] text-gray-200 rounded-3xl'><p>Hello, my name is</p></div>
            <div className='h-[85px] p-1 bg-gray-200 text-black place-content-center'><h1 className={caveat.className}>Samuel Hendryx</h1></div>
